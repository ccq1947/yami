	 ...
	 */
        function getForm($name)
        {
            ...
            if($form){
                ...
                $return .=   '<fieldset id="wrapperextrafield_'.$name.'" class="panelform" >
...
/*
                                    ...
                                    if( JFile::exists($file)){
                                        ...
                                        if ($field->type ==  $plugin_name ) {
                                               if($backendcategory){ 
                                                ...
                                                //SAlvar los parentesis menos en TAGS **************************
                                                if($field->type!= "tags") $value = addslashes($value);
											    ...
											    $extras = addslashes($field->extras);
                                                
                                                
                                               $function  =  'plgfieldsattachment_'.$obj.'::renderInput('.$id.','.$field->id.',"'.$value.'","'.$extras.'");';                                              
	...
	*/
        function getAlias($id)
        {
            ...
            $query = 'SELECT  a.alias  FROM #__content as a   WHERE a.id =  '.$id.' ';
